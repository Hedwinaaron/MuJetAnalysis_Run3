...
process.load("MuJetAnalysis_Run3.MuJetProducer.MuJetProducerRun2_cff")#Run2 mu-jet cluster
process.load("MuJetAnalysis_Run3.CutFlowAnalyzer.CutFlowAnalyzer_MiniAOD_Run3_cff")
