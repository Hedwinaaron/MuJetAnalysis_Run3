...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/user/h/hencinas/Dark_photo_sample_analysis/CMSSW_12_4_11_patch3/src/13p6Tev_samples/cT_100/DarkSUSY_mH_125_mN1_10_mND_1_mGammaD_0p25_13p6TeV_cT_100_events100k_MINIAOD.root')
)
...
process.MuJetProducer = cms.EDProducer("MuJetProducerRun2",
...
process.PFMuJetProducer05PXBL4PXFL3 = cms.EDProducer("MuJetProducerRun2",
...
process.cutFlowAnalyzer = cms.EDAnalyzer("CutFlowAnalyzer_MiniAOD",
...
process.cutFlowAnalyzerPXBL4PXFL3 = cms.EDAnalyzer("CutFlowAnalyzer_MiniAOD",
    DiMuons_Iso_Max = cms.double(2.0),
    MeasurementTracker = cms.string(''),
    MeasurementTrackerEvent = cms.InputTag("MeasurementTrackerEvent"),
    NavigationSchool = cms.string('SimpleNavigationSchool'),
    ...
    muPairs = cms.InputTag("PFMuJetProducer05PXBL4PXFL3","Pairs"),
    muons = cms.InputTag("slimmedMuons"),
    nThrowsConsistentVertexesCalculator = cms.int32(0),
    orthogonalHltPaths = cms.vstring(
        'HLT_CaloMET350_HBHECleaned',
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('124X_mcRun3_2022_realistic_postEE_v1'),
...
process.MuJetProducers = cms.Sequence(process.PFMuJetProducer05PXBL4PXFL3)


process.cutFlowAnalyzers = cms.Sequence(process.cutFlowAnalyzerPXBL4PXFL3)


process.p = cms.Path(process.unpackedTracksAndVertices+process.MuJetProducers+process.cutFlowAnalyzers)
