...
void MuJetProducerRun2::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
 ...
 //edm::Handle<reco::TransientTrackBuilder>  transientTrackBuilder;
  //iEvent.getByToken(theB, transientTrackBuilder)
  ...
  if (m_calculateVertex) {
    ...
    transientTrackBuilder_ptr = &*theB;
  }
...
/*
  ...
  */
  ...
  std::cout<<"____________________End MujetProducer____________________"<<std::endl;
}
